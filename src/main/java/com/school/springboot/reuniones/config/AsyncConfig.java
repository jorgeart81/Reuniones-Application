package com.school.springboot.reuniones.config;

import com.school.springboot.reuniones.async.BuscaListener;
...
public class AsyncConfig {
    private static final String QUEUE_NAME = "busca-persona";
